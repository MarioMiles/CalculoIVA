...
public class calculoIva extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Calculo de IVA</h1>");
            out.println("<h1>Importe sin IVA:"+ ImporteSinIva + "</h1>");
            out.println("<h1>Cuota de IVA:"+ cuotaIva + "</h1>");
            out.println("<h1>Importe con IVA:"+ precioConIva + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
